...
OPTIONS:
    ...
    -a, --addr <ADDR>            [default: http://127.0.0.1:8080/report]
        ...
        --cm <CM_ADDR>           China Mobile probe addr [default: cm.gouer.vip:80]
        --ct <CT_ADDR>           China Telecom probe addr [default: ct.gouer.vip:80]
        --cu <CU_ADDR>           China Unicom probe addr [default: cu.gouer.vip:80]
...
./stat_client -a "grpc://127.0.0.1:9394" -u h1 -p p1 --cm=cm.gouer.vip:80
